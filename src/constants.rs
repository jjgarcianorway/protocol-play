...
// Menu — uses game teal palette (CLEAR_COLOR based)
#[cfg(feature = "player")]
pub const MENU_BG: (f32, f32, f32) = (0.04, 0.06, 0.10);
#[cfg(feature = "player")]
pub const MENU_BTN_PRIMARY: (f32, f32, f32, f32) = (0.18, 0.52, 0.48, 0.92);
#[cfg(feature = "player")]
pub const MENU_BTN_SECONDARY: (f32, f32, f32, f32) = (0.14, 0.18, 0.24, 0.80);
#[cfg(feature = "player")]
pub const MENU_BTN_HOVER: (f32, f32, f32, f32) = (0.24, 0.62, 0.56, 0.95);
#[cfg(feature = "player")]
pub const MENU_TITLE_SIZE: f32 = 52.0;
#[cfg(feature = "player")]
pub const MENU_SUBTITLE_SIZE: f32 = 22.0;
#[cfg(feature = "player")]
pub const MENU_TAGLINE_SIZE: f32 = 15.0;
#[cfg(feature = "player")]
pub const MENU_BTN_FONT: f32 = 22.0;
#[cfg(feature = "player")]
pub const MENU_BTN_SMALL_FONT: f32 = 16.0;
#[cfg(feature = "player")]
pub const MENU_BG_BOARD_SIZE: u32 = 7;
#[cfg(feature = "player")]
...
#[cfg(feature = "player")]
pub const MENU_OVERLAY_ALPHA: f32 = 0.42;
