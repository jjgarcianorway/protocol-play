...
// Colors chosen for maximum visual distinction (Gemini high-contrast palette)
...
pub const COUNT_AVAIL_COLOR: (f32, f32, f32) = (0.9, 0.9, 0.9);
pub const COUNT_EMPTY_COLOR: (f32, f32, f32) = (0.6, 0.6, 0.6);
...
// Menu
#[cfg(feature = "player")]
pub const MENU_BG: (f32, f32, f32) = (0.05, 0.05, 0.09);
#[cfg(feature = "player")]
pub const MENU_BTN_PRIMARY: (f32, f32, f32, f32) = (0.22, 0.42, 0.68, 0.90);
#[cfg(feature = "player")]
pub const MENU_BTN_SECONDARY: (f32, f32, f32, f32) = (0.15, 0.17, 0.22, 0.70);
#[cfg(feature = "player")]
pub const MENU_BTN_HOVER: (f32, f32, f32, f32) = (0.30, 0.52, 0.78, 0.95);
#[cfg(feature = "player")]
pub const MENU_TITLE_SIZE: f32 = 44.0;
#[cfg(feature = "player")]
pub const MENU_SUBTITLE_SIZE: f32 = 18.0;
#[cfg(feature = "player")]
pub const MENU_TAGLINE_SIZE: f32 = 13.0;
#[cfg(feature = "player")]
pub const MENU_BTN_FONT: f32 = 20.0;
#[cfg(feature = "player")]
pub const MENU_BTN_SMALL_FONT: f32 = 16.0;
#[cfg(feature = "player")]
pub const MENU_BG_BOARD_SIZE: u32 = 6;
#[cfg(feature = "player")]
pub const MENU_CAMERA_ORBIT_SPEED: f32 = 0.08;
#[cfg(feature = "player")]
pub const MENU_CAMERA_DISTANCE: f32 = 10.0;
#[cfg(feature = "player")]
pub const MENU_CAMERA_ELEVATION: f32 = 45.0;
#[cfg(feature = "player")]
pub const MENU_OVERLAY_ALPHA: f32 = 0.70;
...
pub const GEN_MIN_PATH_LENGTH: usize = 7;
