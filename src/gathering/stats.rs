...
pub fn save_session(state: &ShipState, best: &mut BestStats) -> bool {
    let stats = SessionStats {
        ...
        crystals_red: state.crystals_red,
        crystals_green: state.crystals_green,
        crystals_blue: state.crystals_blue,
        crystals_yellow: state.crystals_yellow,
        crystals_purple: state.crystals_purple,
